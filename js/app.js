    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                navigation: {
                    prevEl: ".controls-main__contol-prev",
                    nextEl: ".controls-main__contol-next"
                },
                on: {}
            });
            if (document.querySelector(".blogs__slider")) new core(".blogs__slider", {
                modules: [ Navigation, Pagination, Parallax ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                navigation: {
                    prevEl: ".blogs__button-prev",
                    nextEl: ".blogs__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        da.init();
        const sectionWatchers = document.querySelectorAll("[data-watch-once]");
        if (sectionWatchers.length) {
            const menuLinkActive = document.querySelector("[data-goto]._navigator-active");
            sectionWatchers.forEach((sectionWatcher => {
                if (menuLinkActive && sectionWatcher) menuLinkActive.classList.remove("_navigator-active");
            }));
        }
        window["FLS"] = true;
        isWebp();
